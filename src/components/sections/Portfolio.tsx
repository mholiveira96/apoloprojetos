...
const projetos: Projeto[] = [
  { nome: 'Búzios Privilege', categoria: 'Residencial', imagem: buzios, disciplina: 'Estrutural + Instalações + Hidrossanitário + Elétrico + Incêndio', destaque: 'Soluções para execução mais segura e menor desperdício em obra vertical.', area: '2.876,03 m²', disciplinasTecnicas: ['estrutural', 'instalacoes', 'hidrossanitario', 'eletrico', 'incendio'] },
  { nome: 'CREI Maria do Socorro', categoria: 'Institucional', imagem: creiSocorro, disciplina: 'Incêndio + Elétrico + Hidrossanitário', destaque: 'Compatibilização técnica para obra pública com mais controle e previsibilidade.', area: '1.477 m²', disciplinasTecnicas: ['incendio', 'eletrico', 'hidrossanitario'] },
  { nome: 'Colinas Park', categoria: 'Residencial', imagem: colinasPark, disciplina: 'Gás', destaque: 'Projeto de instalações de gás para condomínio residencial multifamiliar.', area: '34.089,84 m²', disciplinasTecnicas: ['instalacoes'] },
  { nome: 'Freeway', categoria: 'Comercial', imagem: freeway, disciplina: 'Hidrossanitário + Incêndio', destaque: 'Projeto comercial com foco em operação eficiente e instalação racional.', area: 'Parnamirim: 2.465,71 m², Alecrim: 3.120,03 m²', disciplinasTecnicas: ['hidrossanitario', 'incendio'] },
  { nome: 'GNC', categoria: 'Comercial', imagem: gnc, disciplina: 'Incêndio', destaque: 'Soluções técnicas para reduzir erro de obra e melhorar desempenho da implantação.', area: '4.263,59 m²', disciplinasTecnicas: ['incendio'] },
  { nome: 'Leapmotor', categoria: 'Comercial', imagem: leapmotor, disciplina: 'Elétrico + Hidrossanitário', destaque: 'Coordenação de projeto para atender operação, custo e prazo com mais segurança.', area: '4.263,59 m²', disciplinasTecnicas: ['eletrico', 'hidrossanitario'] },
  { nome: 'Liivs', categoria: 'Residencial', imagem: liivs, disciplina: 'Estrutural + Incêndio + Elétrico + Hidrossanitário', destaque: 'Compatibilização para obra residencial mais eficiente e previsível.', area: 'Liiv Pipa: 1.359,54 m², Liiv Hub: 803,70 m², Liiv Costeira: 733,49 m², Liiv Cobogó: 778,12 m²', disciplinasTecnicas: ['estrutural', 'incendio', 'eletrico', 'hidrossanitario'] },
  { nome: 'Porto Mar de Pirangi', categoria: 'Residencial', imagem: pirangi, disciplina: 'Estrutural + Contenção + Incêndio + Gás + Hidrossanitário + Elétrico', destaque: 'Integração entre disciplinas para evitar improviso e proteger cronograma.', area: '2.475,92 m²', disciplinasTecnicas: ['estrutural', 'instalacoes', 'incendio', 'hidrossanitario', 'eletrico', 'complementares'] },
  { nome: 'Selfit', categoria: 'Comercial', imagem: selfit, disciplina: 'Captação e drenagem pluvial', destaque: 'Projetos de captação e drenagem de águas pluviais.', area: 'Nova Parnamirim: 1.787,57 m², Nevaldo Rocha: 671,15 m²', disciplinasTecnicas: ['complementares'] },
  { nome: 'Sicilia Cucina', categoria: 'Comercial', imagem: sicilia, disciplina: 'Incêndio + Hidrossanitário + Elétrico', destaque: 'Precisão técnica para implantação comercial com menos retrabalho.', area: '552 m²', disciplinasTecnicas: ['incendio', 'hidrossanitario', 'eletrico'] },
  { nome: 'Solar Cidade Alta', categoria: 'Residencial', imagem: solarCidadeAlta, disciplina: 'Incêndio', destaque: 'Soluções de prevenção e combate a incêndio para obra mais segura e coordenada.', area: '7.260,89 m²', disciplinasTecnicas: ['incendio'] },
]
